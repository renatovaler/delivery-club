...
import { HelpCircle } from "lucide-react"; // Retained for a general FAQ icon, even if not explicitly in the outline's header example
import {
  Accordion,
  AccordionContent,
  AccordionItem,
  ...
  return (
    <div className="w-full p-6 md:p-8 space-y-8 max-w-4xl mx-auto">
      <div className="text-center">
        <HelpCircle className="w-12 h-12 mx-auto text-slate-500 mb-4" /> {/* Icon added for visual consistency */}
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Perguntas Frequentes</h1>
        <p className="text-slate-600">Encontre respostas para as dúvidas mais comuns sobre a plataforma.</p>
      </div>
